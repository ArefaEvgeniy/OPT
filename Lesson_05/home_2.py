...
# Затем результат преобразовать снова в байтовый, только уже
# в кодировке ‘Latin1’ И на конец результат снова декодировать
# в строку (результаты всех преобразований выводить на экран).
